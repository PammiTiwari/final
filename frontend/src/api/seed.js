...
export const REQUESTS = [
  {
    ...
    image_urls: ["/uploads/pothole.jpg", "/uploads/footpath.jpg", "/uploads/road-damage.jpg"], evidence_urls: [],
  ...
  },
  {
    ...
    address: "Park Street, near School, Preetam Nagar (Ward-2)", ward: "Ward-2",
    priority: "high", status: "pending",
    admin_notes: null,
    image_urls: [], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false, assignment: null,
    created_at: daysAgo(8), updated_at: daysAgo(8), resolved_at: null,
  },
  {
    id: 3, cmp_id: "CMP0003",
    ...
    image_urls: ["/uploads/road-damage.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 2, request_id: 3, staff_id: 2, staff_name: "Rajesh Kumar", staff_department: "Road Maintenance", assigned_by: 1, notes: "Road fully repaired and patched.", assigned_at: daysAgo(20, 12), completed_at: daysAgo(15) },
    created_at: daysAgo(20), updated_at: daysAgo(15), resolved_at: daysAgo(15),
  },
  {
    id: 4, cmp_id: "CMP0004",
    citizen_id: 10, citizen_name: "Sunita Mehta", citizen_email: "sunita@gmail.com", citizen_phone: "9111111104",
    category: "road", department: "Road Maintenance",
    title: "Speed breaker needed near temple",
    ...
    address: "Temple Road, Preetam Nagar (Ward-4)", ward: "Ward-4",
  ...
  },
  {
    ...
    image_urls: ["/uploads/streetlight.jpg", "/uploads/dark-street.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 3, request_id: 5, staff_id: 3, staff_name: "Priya Singh", staff_department: "Electricity Department", assigned_by: 1, notes: "Maintenance team assigned. Bulb replacement in progress.", assigned_at: daysAgo(3, 12), completed_at: null },
  ...
  },
  {
    ...
    citizen_id: 8, citizen_name: "Neha Verma", citizen_email: "neha@gmail.com", citizen_phone: "9111111102",
    category: "electricity", department: "Electricity Department",
    title: "Multiple streetlights down on Park Street",
    ...
    address: "Park Street, Preetam Nagar (Ward-2)", ward: "Ward-2",
    priority: "high", status: "assigned",
    admin_notes: "Inspected. Parts ordered.",
    image_urls: ["/uploads/dark-street.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 4, request_id: 6, staff_id: 3, staff_name: "Priya Singh", staff_department: "Electricity Department", assigned_by: 1, notes: "Inspected. Parts ordered.", assigned_at: daysAgo(6, 12), completed_at: null },
    created_at: daysAgo(6), updated_at: daysAgo(6, 12), resolved_at: null,
  },
  {
    id: 7, cmp_id: "CMP0007",
    citizen_id: 11, citizen_name: "Arjun Singh", citizen_email: "arjun@gmail.com", citizen_phone: "9111111105",
    category: "electricity", department: "Electricity Department",
    title: "Electrical pole leaning dangerously",
    ...
    address: "Main Road, Preetam Nagar (Ward-5)", ward: "Ward-5",
    priority: "urgent", status: "pending",
    admin_notes: null,
    image_urls: ["/uploads/electric-pole.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false, assignment: null,
    created_at: daysAgo(1), updated_at: daysAgo(1), resolved_at: null,
  },
  {
    id: 8, cmp_id: "CMP0008",
    citizen_id: 9, citizen_name: "Ravi Gupta", citizen_email: "ravi.g@gmail.com", citizen_phone: "9111111103",
    ...
    image_urls: [], evidence_urls: ["/uploads/streetlight.jpg"],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 5, request_id: 8, staff_id: 3, staff_name: "Priya Singh", staff_department: "Electricity Department", assigned_by: 1, notes: "Transformer replaced. Power restored.", assigned_at: daysAgo(15, 12), completed_at: daysAgo(13) },
  ...
  },
  {
    ...
    title: "Water pipeline leakage on Green Avenue",
    ...
    address: "Green Avenue, Preetam Nagar (Ward-4)", ward: "Ward-4",
    priority: "high", status: "in_progress",
    admin_notes: "Crew deployed. Pipe repair underway.",
    image_urls: ["/uploads/flooding.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 6, request_id: 9, staff_id: 4, staff_name: "Imran Khan", staff_department: "Water Supply Department", assigned_by: 1, notes: "Crew deployed. Pipe repair underway.", assigned_at: daysAgo(4, 12), completed_at: null },
    created_at: daysAgo(4), updated_at: daysAgo(4, 12), resolved_at: null,
  },
  {
    id: 10, cmp_id: "CMP0010",
    citizen_id: 7, citizen_name: "Amit Sharma", citizen_email: "amit@gmail.com", citizen_phone: "9111111101",
    category: "water", department: "Water Supply Department",
    ...
    address: "Block A, MG Road, Preetam Nagar (Ward-1)", ward: "Ward-1",
    priority: "urgent", status: "pending",
    admin_notes: null,
    image_urls: ["/uploads/dirty-water.jpg", "/uploads/water-pipe.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false, assignment: null,
    created_at: daysAgo(3), updated_at: daysAgo(3), resolved_at: null,
  },
  {
    id: 11, cmp_id: "CMP0011",
    citizen_id: 11, citizen_name: "Arjun Singh", citizen_email: "arjun@gmail.com", citizen_phone: "9111111105",
    category: "water", department: "Water Supply Department",
    title: "Contaminated drinking water complaints",
    ...
    admin_notes: "Water sample taken for testing.",
    image_urls: [], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 7, request_id: 11, staff_id: 4, staff_name: "Imran Khan", staff_department: "Water Supply Department", assigned_by: 1, notes: "Water sample taken for testing.", assigned_at: daysAgo(7, 12), completed_at: null },
    created_at: daysAgo(7), updated_at: daysAgo(7, 12), resolved_at: null,
  },
  {
    id: 12, cmp_id: "CMP0012",
    citizen_id: 8, citizen_name: "Neha Verma", citizen_email: "neha@gmail.com", citizen_phone: "9111111102",
    category: "water", department: "Water Supply Department",
    ...
    image_urls: ["/uploads/manhole.jpg", "/uploads/flooding.jpg"], evidence_urls: ["/uploads/recreation-park.jpg"],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 8, request_id: 12, staff_id: 4, staff_name: "Imran Khan", staff_department: "Water Supply Department", assigned_by: 1, notes: "Drainage cleared. Good for monsoon season.", assigned_at: daysAgo(18, 12), completed_at: daysAgo(16) },
    created_at: daysAgo(18), updated_at: daysAgo(16), resolved_at: daysAgo(16),
  },
  {
    id: 13, cmp_id: "CMP0013",
    citizen_id: 9, citizen_name: "Ravi Gupta", citizen_email: "ravi.g@gmail.com", citizen_phone: "9111111103",
  ...
  },
  {
    ...
    address: "Main Market, Preetam Nagar (Ward-4)", ward: "Ward-4",
    priority: "high", status: "in_progress",
    admin_notes: "Extra garbage truck deployed.",
    image_urls: ["/uploads/garbage-bins.jpg", "/uploads/garbage.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 9, request_id: 14, staff_id: 5, staff_name: "Sandeep Yadav", staff_department: "Sanitation Department", assigned_by: 1, notes: "Extra garbage truck deployed.", assigned_at: daysAgo(5, 12), completed_at: null },
    created_at: daysAgo(5), updated_at: daysAgo(5, 12), resolved_at: null,
  },
  {
    id: 15, cmp_id: "CMP0015",
    citizen_id: 11, citizen_name: "Arjun Singh", citizen_email: "arjun@gmail.com", citizen_phone: "9111111105",
    category: "sanitation", department: "Sanitation Department",
    title: "Open defecation in public area",
    ...
    address: "Railway Road, Preetam Nagar (Ward-5)", ward: "Ward-5",
    priority: "urgent", status: "resolved",
    admin_notes: "Mobile toilet installed. Area cleaned.",
    image_urls: [], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 10, request_id: 15, staff_id: 5, staff_name: "Sandeep Yadav", staff_department: "Sanitation Department", assigned_by: 1, notes: "Mobile toilet installed. Area cleaned.", assigned_at: daysAgo(25, 12), completed_at: daysAgo(20) },
    created_at: daysAgo(25), updated_at: daysAgo(20), resolved_at: daysAgo(20),
  },
  {
    id: 16, cmp_id: "CMP0016",
    citizen_id: 7, citizen_name: "Amit Sharma", citizen_email: "amit@gmail.com", citizen_phone: "9111111101",
    ...
    priority: "medium", status: "pending",
    admin_notes: null,
    image_urls: ["/uploads/playground.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false, assignment: null,
    created_at: daysAgo(10), updated_at: daysAgo(10), resolved_at: null,
  },
  {
    id: 17, cmp_id: "CMP0017",
    citizen_id: 8, citizen_name: "Neha Verma", citizen_email: "neha@gmail.com", citizen_phone: "9111111102",
    category: "parks", department: "Parks & Public Spaces",
    title: "Trees blocking CCTV cameras",
    ...
    address: "Main Boulevard, Preetam Nagar (Ward-2)", ward: "Ward-2",
    priority: "medium", status: "assigned",
    admin_notes: "Tree trimming crew scheduled for next week.",
    image_urls: ["/uploads/trees.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 11, request_id: 17, staff_id: 6, staff_name: "Kavita Sharma", staff_department: "Parks & Public Spaces", assigned_by: 1, notes: "Tree trimming crew scheduled for next week.", assigned_at: daysAgo(9, 12), completed_at: null },
    created_at: daysAgo(9), updated_at: daysAgo(9, 12), resolved_at: null,
  },
  {
    id: 18, cmp_id: "CMP0018",
    citizen_id: 9, citizen_name: "Ravi Gupta", citizen_email: "ravi.g@gmail.com", citizen_phone: "9111111103",
    category: "parks", department: "Parks & Public Spaces",
    title: "Public toilet in bad condition",
    ...
    address: "Civil Lines Road Bus Stop, Preetam Nagar (Ward-3)", ward: "Ward-3",
    priority: "high", status: "resolved",
    admin_notes: "Toilet renovated and cleaned. New doors installed.",
    image_urls: [], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 12, request_id: 18, staff_id: 6, staff_name: "Kavita Sharma", staff_department: "Parks & Public Spaces", assigned_by: 1, notes: "Toilet renovated and cleaned. New doors installed.", assigned_at: daysAgo(30, 12), completed_at: daysAgo(25) },
    created_at: daysAgo(30), updated_at: daysAgo(25), resolved_at: daysAgo(25),
  },
  {
    id: 19, cmp_id: "CMP0019",
    citizen_id: 10, citizen_name: "Sunita Mehta", citizen_email: "sunita@gmail.com", citizen_phone: "9111111104",
    category: "parks", department: "Parks & Public Spaces",
    title: "Damaged benches in community park",
    ...
    address: "Community Park Road, Preetam Nagar (Ward-4)", ward: "Ward-4",
    priority: "low", status: "pending",
    admin_notes: null,
    image_urls: [], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false, assignment: null,
    created_at: daysAgo(14), updated_at: daysAgo(14), resolved_at: null,
  },
  {
    id: 20, cmp_id: "CMP0020",
    citizen_id: 11, citizen_name: "Arjun Singh", citizen_email: "arjun@gmail.com", citizen_phone: "9111111105",
    category: "other", department: "Sanitation Department",
    title: "Stray dogs menace in residential area",
    ...
    admin_notes: "Animal control team visited. Dogs vaccinated and relocated.",
    image_urls: ["/uploads/stray-dog.jpg"], evidence_urls: ["/uploads/recreation-park.jpg"],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 13, request_id: 20, staff_id: 5, staff_name: "Sandeep Yadav", staff_department: "Sanitation Department", assigned_by: 1, notes: "Animal control team visited. Dogs vaccinated and relocated.", assigned_at: daysAgo(35, 12), completed_at: daysAgo(30) },
    created_at: daysAgo(35), updated_at: daysAgo(30), resolved_at: daysAgo(30),
  },
  {
    id: 21, cmp_id: "CMP0021",
    citizen_id: 7, citizen_name: "Amit Sharma", citizen_email: "amit@gmail.com", citizen_phone: "9111111101",
    category: "road", department: "Road Maintenance",
    title: "Missing manhole cover on MG Road",
    ...
    address: "MG Road, School Junction, Preetam Nagar (Ward-1)", ward: "Ward-1",
    priority: "urgent", status: "in_progress",
    admin_notes: "Cover ordered. Temporary barricade placed.",
    image_urls: ["/uploads/road-damage.jpg"], evidence_urls: [],
    pending_funds: false, hold_reason: null, reopen_count: 0,
    upvotes_count: 0, upvoted_by_me: false,
    assignment: { id: 14, request_id: 21, staff_id: 2, staff_name: "Rajesh Kumar", staff_department: "Road Maintenance", assigned_by: 1, notes: "Cover ordered. Temporary barricade placed.", assigned_at: daysAgo(2, 12), completed_at: null },
...
export const NOTIFICATIONS = [
  ...
  { id: 3, user_id: 8,  title: "Complaint Assigned",    message: "Your complaint CMP0006 (Multiple streetlights down on Park Street) has been assigned to Electricity Department.",    notif_type: "info",    is_read: false, created_at: daysAgo(6, 12) },
  { id: 4, user_id: 9,  title: "Complaint Resolved",    message: "Your complaint CMP0003 (Road cave-in at Nehru Chowk) has been resolved. Please verify and close.",                  notif_type: "success", is_read: false, created_at: daysAgo(15) },
  { id: 5, user_id: 10, title: "Complaint In Progress", message: "Work has started on your complaint CMP0009 (Water pipeline leakage). Our crew is on site.",                          notif_type: "info",    is_read: false, created_at: daysAgo(4, 12) },
  { id: 6, user_id: 2,  title: "New Assignment",        message: "You have been assigned complaint CMP0001 - Large potholes on MG Road. Please take action.",                          notif_type: "warning", is_read: true,  created_at: daysAgo(12, 12) },
  { id: 7, user_id: 3,  title: "New Assignment",        message: "You have been assigned complaint CMP0005 - Street light not working near Sector 5 park.",                              notif_type: "warning", is_read: false, created_at: daysAgo(3, 12) },
  { id: 8, user_id: 1,  title: "New Complaints",        message: "5 new complaints have been submitted in the last 24 hours. Please review and assign.",                               notif_type: "info",    is_read: false, created_at: daysAgo(1) },
]
...
export const POSTS = [
  {
    ...
    image_urls: ["/uploads/dark-street.jpg", "/uploads/streetlight.jpg"],
  ...
  {
    id: 3, citizen_id: 9, author_name: "Ravi Gupta", author_role: "citizen", author_department: null,
    title: null, category: "general", is_official: false,
    ...
    location: "MG Road Junction, Preetam Nagar (Ward-1)", ward: "Ward-1",
    image_urls: ["/uploads/pothole.jpg"],
    likes_count: 3, comments_count: 2, liked_by_me: false,
    created_at: daysAgo(1, 9),
    comments_list: [
      { id: 5, post_id: 3, user_id: 10, author_name: "Sunita Mehta", author_role: "citizen", author_department: null,               is_official: false, content: "I've been reporting this pothole for 2 months! Still not fixed.",              created_at: daysAgo(1, 9, 30) },
      { id: 6, post_id: 3, user_id: 2,  author_name: "Rajesh Kumar", author_role: "staff",   author_department: "Road Maintenance", is_official: true,  content: "Work order has been issued. Our crew will be at the site tomorrow morning.", created_at: daysAgo(1, 10) },
    ],
  },
  {
    id: 4, citizen_id: 10, author_name: "Sunita Mehta", author_role: "citizen", author_department: null,
    title: null, category: "general", is_official: false,
    ...
    location: "Green Avenue, Preetam Nagar (Ward-4)", ward: "Ward-4",
    image_urls: ["/uploads/dirty-water.jpg"],
    likes_count: 0, comments_count: 1, liked_by_me: false,
    created_at: daysAgo(1, 14),
    comments_list: [
      { id: 7, post_id: 4, user_id: 11, author_name: "Arjun Singh", author_role: "citizen", author_department: null, is_official: false, content: "We face the same in Ward-5. Only 20 minutes of water daily!", created_at: daysAgo(1, 14, 30) },
    ],
  },
  {
    id: 5, citizen_id: 11, author_name: "Arjun Singh", author_role: "citizen", author_department: null,
    title: null, category: "general", is_official: false,
    ...
    location: "Nehru Colony Park, Preetam Nagar (Ward-5)", ward: "Ward-5",
    image_urls: ["/uploads/playground.jpg"],
    likes_count: 0, comments_count: 1, liked_by_me: false,
    created_at: daysAgo(2, 10),
    comments_list: [
      { id: 8, post_id: 5, user_id: 7, author_name: "Amit Sharma", author_role: "citizen", author_department: null, is_official: false, content: "Please repair the park near our area too! Kids have no safe place to play.", created_at: daysAgo(2, 10, 30) },
    ],
  },
  {
    id: 6, citizen_id: 7, author_name: "Amit Sharma", author_role: "citizen", author_department: null,
    title: null, category: "general", is_official: false,
  ...
  {
    id: 7, citizen_id: 1, author_name: "Preetam Nagar Admin", author_role: "admin", author_department: "Administration",
  ...
  {
    id: 8, citizen_id: 1, author_name: "Preetam Nagar Admin", author_role: "admin", author_department: "Administration",
  ...
  {
    id: 9, citizen_id: 1, author_name: "Preetam Nagar Admin", author_role: "admin", author_department: "Administration",
    title: "Monsoon Preparedness Advisory", category: "announcement", is_official: true,
  ...
  {
    id: 10, citizen_id: 8, author_name: "Neha Verma", author_role: "citizen", author_department: null,
    title: null, category: "general", is_official: false,
    ...
    location: "Park Street, Preetam Nagar (Ward-2)", ward: "Ward-2",
    image_urls: [],
    likes_count: 3, comments_count: 0, liked_by_me: false,
    created_at: daysAgo(4, 15),
    comments_list: [],
  },
]

// ── Payments (derived from booking.payment for the /payments endpoint) ────────
export const PAYMENTS = BOOKINGS.filter(b => b.payment).map(b => b.payment)

// ── Announcements (kept for announcements-only page) ───────────────────────────
